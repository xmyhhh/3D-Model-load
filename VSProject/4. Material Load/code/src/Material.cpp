...
#include <vector>
using std::vector;
Material::Material(aiMaterial* pMaterial, const string& directory) {
...
vector<Texture> Material::loadMaterialTextures(aiMaterial* mat, aiTextureType type, const string& directory, string typeName)
{
...
unsigned int Material::TextureFromFile(const char* path, const string& directory)
{
